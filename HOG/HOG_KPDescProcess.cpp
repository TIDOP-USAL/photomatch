...
using namespace cv;
HOG_KPDescProcess::HOG_KPDescProcess(cv::Mat &cvImgLeft,cv::Mat &cvImgRight, std::vector<cv::KeyPoint> &cvkeyLeft,std::vector<cv::KeyPoint> &cvkeyRight,cv::Mat &cvDescLeft,cv::Mat &cvDescRight,int sizePatch,QString leftImageName,QString rightImageName):
