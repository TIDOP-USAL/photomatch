...
using namespace cv;
BFMatcherProcess::BFMatcherProcess(cv::Mat &cvDescLeft,cv::Mat &cvDescRight,std::vector<std::vector<cv::DMatch>> &matchesL2R,std::vector<std::vector<cv::DMatch>> &matchesR2L,QString leftImageName,QString rightImageName):
