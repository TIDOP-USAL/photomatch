#include "Wang_Zheng_Hu_Li2013_Process.h"
...
bool WangZhengHuLi2013(const cv::Mat &ori, cv::Mat &ret)
{
  if (ori.type() != CV_8UC3) {
...
Wang_Zheng_Hu_Li2013_Process::Wang_Zheng_Hu_Li2013_Process(cv::Mat& cvImg_Left, cv::Mat& cvImg_Right, const QDir &outputDir) 
