...
YuBajaj2004_Process::YuBajaj2004_Process(cv::Mat& cvImg_Left, cv::Mat& cvImg_Right, const cv::Size &blockSize, float c, bool anisotropicMode, float r, const QDir &outputDir)
  : mCvImg_left(cvImg_Left),
    mCvImg_right(cvImg_Right),
    mBlockSize(blockSize),
    mC(c),
    mAnisotropicMode(anisotropicMode),
    mR(r),
