...
{
  connect(mMaxFeatures,       QOverload<int>::of(&QSpinBox::valueChanged),            this, &GfttWidget::maxFeaturesChange);
  connect(mQualityLevel,      QOverload<double>::of(&QDoubleSpinBox::valueChanged),   this, &GfttWidget::qualityLevelChange);
  connect(mMinDistance,       QOverload<double>::of(&QDoubleSpinBox::valueChanged),   this, &GfttWidget::minDistanceChange);
  connect(mBlockSize,         QOverload<int>::of(&QSpinBox::valueChanged),            this, &GfttWidget::blockSizeChange);
  connect(mHarrisDetector,    &QAbstractButton::clicked,                              this, &GfttWidget::harrisDetectorChange);
  connect(mK,                 QOverload<double>::of(&QDoubleSpinBox::valueChanged),   this, &GfttWidget::kChange);
}
...
{
  mGroupBox->setTitle(QApplication::translate("GfttWidget", "GFTT Parameters"));
  mLabelMaxFeatures->setText(QApplication::translate("GfttWidget", "Max Features:"));
  mLabelQualityLevel->setText(QApplication::translate("GfttWidget", "Quality Level:"));
  mLabelMinDistance->setText(QApplication::translate("GfttWidget", "Min Distance:"));
  mLabelBlockSize->setText(QApplication::translate("GfttWidget", "Block Size:"));
  mHarrisDetector->setText(QApplication::translate("GfttWidget", "Harris Detector"));
  mLabelK->setText(QApplication::translate("GfttWidget", "K:"));
}
