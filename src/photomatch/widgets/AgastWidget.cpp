...
{
  mGroupBox->setTitle(QApplication::translate("AgastWidgetImp", "AGAST Parameters", nullptr));
  mLabelThreshold->setText(QApplication::translate("AgastWidgetImp", "Threshold:", nullptr));
  mNonmaxSuppression->setText(QApplication::translate("AgastWidgetImp", "Nonmax Suppression:", nullptr));
  mLabelDetectorType->setText(QApplication::translate("AgastWidgetImp", "Detector Type:", nullptr));
...
void AgastWidgetImp::changeEvent(QEvent *event)
{
