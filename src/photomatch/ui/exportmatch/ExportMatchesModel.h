...
#include "photomatch/ui/exportmatch/ExportMatches.h"
...
private:
  ...
  void exportOrima(const QString &file) const;
  void exportBingo(const QString &file) const;
...
public slots:
  ...
  void exportMatches(const QString &file,
