...
{
  connect(mView, &NewSessionView::sessionNameChange, this, &NewSessionPresenterImp::checkSessionName);

  connect(mView, &QDialog::accepted, this, &NewSessionPresenterImp::saveProject);
  connect(mView, &QDialog::rejected, this, &NewSessionPresenterImp::discartProject);
  connect(mView, &PhotoMatchDialogView::help, this, &NewSessionPresenterImp::help);
}
